...
import { type TeamMemberForm, type Project, type TeamMember, teamMembersSchema, teamMemberSchema } from "../types";
...
export async function getProjectTeam(projectId:Project['_id']) {
    try {
        ...
        const response = teamMembersSchema.safeParse(data) // Comprobamos con zod
        if(response.success) {
