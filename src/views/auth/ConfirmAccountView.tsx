...
import type { ConfirmToken } from "@/types/index"; // Viene como objeto entonces usamos el lookUp
...
export default function ConfirmAccountView() {
    ...
    const handleComplete = (token:ConfirmToken['token']) => { // Le pasamos token para que se traiga el ultimo digito
        mutate(token)
    }
