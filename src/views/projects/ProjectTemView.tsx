...
export default function ProjectTemView() {
  ...
  if(data) return ( // Si tenemos datos entonces retornamos el componente
    <>
        <h1 className="text-5xl font-black">Administrar Equipo</h1>
        <p className="text-2xl font-light text-gray-500 mt-5">Administra el equipo de trabajo</p>
        ...
        <nav className="my-5 flex gap-3">
            ...
            <Link 
                to={`/projects/${projectId}`} // A la URL actual pero le agregamos team
